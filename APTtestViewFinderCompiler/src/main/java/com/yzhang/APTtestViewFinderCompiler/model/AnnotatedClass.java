...
import com.yzhang.APTtestViewFinderCompiler.TypeUtil;
...
public class AnnotatedClass {
    ...
    public List<FindViewByIDField> mFields;
    ...
    public void addField(FindViewByIDField field) {
        mFields.add(field);
    }
    ...
    public JavaFile generateFinder() {
        ...
        for (FindViewByIDField field : mFields) {
            // find views
