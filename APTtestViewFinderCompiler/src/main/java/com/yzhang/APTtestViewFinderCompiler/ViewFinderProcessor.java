...
import com.yzhang.APTtestViewFinderCompiler.model.AnnotatedClass;
import com.yzhang.APTtestViewFinderCompiler.model.FindViewByIDField;
import com.yzhang.APTtestViewFinderCompiler.model.OnClickMethod;
...
public class ViewFinderProcessor extends AbstractProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        types.add(FindViewByID.class.getCanonicalName());
    ...
    private void processBindView(RoundEnvironment roundEnv) throws IllegalArgumentException {
        for (Element element : roundEnv.getElementsAnnotatedWith(FindViewByID.class)) {
            // TODO: 16/8/4 检查 字段 的修饰符
            AnnotatedClass annotatedClass = getAnnotatedClass(element);
            FindViewByIDField field = new FindViewByIDField(element);
