package com.yzhang.okhttputils;
...
import com.yzhang.utils.BitmapUtils;
...
/**
 * Created by yzhang on 2017/2/22.
 */
    ...
    private void _displayImage(final ImageView view, final String url, final int errorResId)
    {
        ...
        call.enqueue(new Callback()
        {
            ...
            public void onResponse(Response response)
            {
                ...
                {
                    is = response.body().byteStream();
                    int inSampleSize = BitmapUtils.calculateInSampleSize(is, view);
                    try
                    {
                        is.reset();
                    } catch (IOException e)
