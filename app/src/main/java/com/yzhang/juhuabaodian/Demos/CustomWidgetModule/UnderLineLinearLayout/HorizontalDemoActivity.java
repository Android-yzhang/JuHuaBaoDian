package com.yzhang.juhuabaodian.Demos.CustomWidgetModule.UnderLineLinearLayout;
...
import com.yzhang.UnderLineLinearLayout.UnderLineLinearLayout;
import com.yzhang.juhuabaodian.R;
import com.yzhang.utils.UIUtils;


public class HorizontalDemoActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.sub:
                ...
                break;
            case R.id.vertical:
                Intent intent = new Intent(this, UnderLineLinearLayoutDemoActivity.class);
            ...
            case R.id.add_marginside:
                int curMargin = UIUtils.pxToDip(this, mUnderLineLinearLayout.getLineMarginSide());
                mUnderLineLinearLayout.setLineMarginSide(UIUtils.dipToPx(this, ++curMargin));
                mCurMargin.setText("current line marginside = " + curMargin + "dp");
                break;
            case R.id.sub_marginside:
                int curMargin2 = UIUtils.pxToDip(this, mUnderLineLinearLayout.getLineMarginSide());
                mUnderLineLinearLayout.setLineMarginSide(UIUtils.dipToPx(this, --curMargin2));
