package com.yzhang.juhuabaodian.Demos.CustomWidgetModule.SweetAlertDialog;
...
public class SweetAlertDialogDemoActivity extends AppCompatActivity implements View.OnClickListener {
    private int i = -1;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sweet_alert_dialog_demo_activity);
